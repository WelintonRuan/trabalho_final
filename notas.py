...
from alunos import buscar_aluno, listar_alunos
    ...
    try:
        ...
        if nota_existente:
            ...
            print(
                ...
                f"no {trimestre}º trimestre:"
            )

            print(f"Nota 1: {nota_existente[0]}")
            print(f"Nota 2: {nota_existente[1]}")
            print(f"Nota 3: {nota_existente[2]}")
            print(f"Média: {nota_existente[3]}")
