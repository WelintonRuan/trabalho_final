...
def ver_notas_aluno_professor(aluno_id, materia):
    ...
    try:
        ...
        print(f"\n--- Notas de {aluno[0]} em {materia.upper()} ---")
        ...
        if not trimestres:
            ...
            for t in trimestres:
                ...
                print(f"  Nota 1: {t[1]}  Nota 2: {t[2]}  Nota 3: {t[3]}")
        ...
        if resultado:
            ...
            print(f"\n  Média Final: {resultado[0]}  |  Situação: {resultado[1]}")
...
def lancar_notas(usuario):
    ...
    try:
        ...
        ver_notas_aluno_professor(aluno_id, materia)
